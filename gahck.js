...
if ( (myURL.match("ganool.com") != null) ){
	...
	var ihateads = ["floating_banner_bottom", "ad_global_header2" , "ad_global_header1" ,"ad_thread_first_post_content" ];
	bitch(ihateads);
	ihateads = ["krucil_ads","tborder","krucil_floating_banner_top"];	
	bitches(ihateads);
	...
	var ihateads = ["banner-top-wrapper","l-link","r-link"];
	var aNext = true;
	bitches(ihateads);
	...
	var ihateads = ["banner","iklankiri","iklankanan","leftbanner","rightbanner","bannerright","bannerleft","ads"];
		bitch(ihateads);
		bitches(ihateads);
}
